<template>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <router-link class="navbar-brand" :to="{ name: 'CapturarPeso' }">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><router-link class="dropdown-item" :to="{ name: 'CapturarPeso' }">Captura de Peso</router-link></li>
                            <li><router-link class="dropdown-item" :to="{ name: 'EquipoList' }">Gestión de Equipos</router-link></li>
                        </ul>
                    </li>
                </ul>
                <ul class="navbar-nav">
...
import 'bootstrap/js/dist/dropdown'; // Importar el componente de dropdown
